...
2. Extraé un fragmento del Evangelio de 70 a 100 palabras (fiel al texto, \
usá "…" si omitís versículos) y marcá con <b></b> únicamente la frase \
central más importante.
3. TEOLOGÍA: 3 a 5 líneas, basada solo en Sagrada Escritura, Catecismo, \
Padres/Doctores de la Iglesia o Magisterio pontificio. Nada de blogs ni \
frases anónimas. Cerrá con una frase de 1-2 líneas.
4. PSICOLOGÍA: 3 a 5 líneas, basada en evidencia (atención, regulación \
emocional, hábitos, paciencia, motivación, relaciones, decisiones). Nada \
de autoayuda ni diagnósticos. Cerrá con una frase de 1-2 líneas.
5. NEUROCIENCIA Y NEUROPLASTICIDAD: 3 a 5 líneas, con lenguaje prudente \
("puede favorecer…", "se asocia con…", "la evidencia sugiere…"). Nada de \
neuromitos ni afirmar cambios inmediatos. Cerrá con una frase de 1-2 líneas.
...
observables, distintas entre sí, redactadas de forma impersonal \
("Dedicar unos minutos a…", "Identificar una situación…").
...
"generado por IA" ni marcas de agua. Pensá que el texto se va a ver dentro \
de una lámina en el celular: cada bloque debe ser CORTO y muy didáctico.
...
Devolvé ÚNICAMENTE un JSON válido (sin marcas de código), con esta forma exacta:
{
  ...
  "evangelio_resumen": "string 70-100 palabras con <b> en la frase central",
  "teologia": {"texto": "...", "frase": "...", "fuente": "..."},
  "psicologia": {"texto": "...", "frase": "...", "fuente": "..."},
  "neurociencia": {"texto": "...", "frase": "...", "fuente": "..."},
  "practicas": [
    {"titulo": "ORAR", "texto": "..."},
    {"titulo": "...", "texto": "..."},
    {"titulo": "...", "texto": "..."}
...
def generar_contenido(gospel: dict, api_key: str | None = None) -> dict:
